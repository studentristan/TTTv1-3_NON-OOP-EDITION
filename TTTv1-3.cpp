...
# include <iostream>
//# include <regex>  // I was going to use regular expressions for input validation like I would in any other language I code in, but they are super ugly in C++
using namespace std;
...
void boardDisplay(){					//uses one array, using board[1-9]			
...
void alreadyTaken() { // also gets run for invalid inputs
